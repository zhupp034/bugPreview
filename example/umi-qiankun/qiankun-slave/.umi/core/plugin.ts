...
import * as Plugin_0 from 'D:/github/test/qiankun-slave/.umi/plugin-model/runtime.tsx';
import * as Plugin_1 from 'D:/github/test/qiankun-slave/.umi/plugin-qiankun-slave/slaveRuntimePlugin.ts';
...
export function getPlugins() {
  return [
    {
      apply: Plugin_0,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/github/test/qiankun-slave/.umi/plugin-model/runtime.tsx',
    },
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/github/test/qiankun-slave/.umi/plugin-qiankun-slave/slaveRuntimePlugin.ts',
    },
  ];
}
